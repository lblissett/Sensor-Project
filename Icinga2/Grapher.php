...
class Grapher extends GrapherHook
{
    ...
    protected $baseUrl = 'http://127.0.0.1:9090/render?';
    ...
    protected $imageUrlMacro = '&target=$target$&source=0&width=300&height=120&hideAxes=true&lineWidth=2&hideLegend=true&colorList=$colorList$&lineMode=connected&areaMode=$areaMode$&areaAlpha=$areaAlpha$';
    ...
    protected $colorList = "049BAF&bgcolor=white&fgcolor=black";
